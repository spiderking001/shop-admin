    ...
    <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
      ...
      <el-table-column label="操作" width="180" align="center">
        <template #default="scope">
          <small v-if="scope.row.super==1" class="text-gray-500 text-small"> 暂无操作</small>
          <div v-else>
    ...
    <FromDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
      <el-form :model="form" ref="formRef" label-width="80px" :inline="false">
        ...
        <el-form-item label="密码" prop="password">
          <el-input v-model="form.password" placeholder="请输入公告内容"/>
        </el-form-item>
...
<script setup>
import {ref} from "vue";
import {getAdminList, updateAdminStatus, addAdmin, editAdmin, deleteAdmin} from "@/api/manager";
...
const {
  ...
  updateStatus
    ...
    = useInitTable(
    {
      ...
      delete:deleteAdmin,
      updateStatus:updateAdminStatus,
    })
